...
* Actualice al plugin de Element para vCenter Server 5.1 o 5.0.
...
+
image::vcp_remote_plugin_icons_home_page.png[Muestra el punto de extensión del plugin después de una actualización o instalación correcta para el plugin de Element versión 5.0 o una versión posterior]
