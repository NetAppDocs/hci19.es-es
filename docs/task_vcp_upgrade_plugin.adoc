...
+
image::vcp_remote_plugin_icons_home_page.png[Muestra el punto de extensión del plugin después de una actualización o una instalación correcta para el plugin de Element versión 5,0 o posterior]
